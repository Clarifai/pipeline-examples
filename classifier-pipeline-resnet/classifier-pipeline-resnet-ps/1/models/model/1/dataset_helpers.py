    ...
    **kwargs,
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for inp in all_inputs:
            input_concepts = [c.id for c in inp.data.concepts if c.value > 0]
            matching = [c for c in input_concepts if c in concepts]
            if matching:
                filtered_inputs.append((inp, matching))
        ...
        def download_single_image(inp_data: Tuple) -> dict:
            ...
            try:
                ...
                return {'input_id': inp.id, 'image_bytes': image_bytes, 'labels': labels, 'success': True}
...
def convert_dataset_to_imagenet_format(
    ...
    """Convert downloaded dataset to ImageNet format for training."""
    ...
    images_dir = os.path.join(data_prefix, "train")
    ...
    for item in downloaded_data:
        ...
        try:
            ...
            label_idx = concept_to_idx[labels[0]]
