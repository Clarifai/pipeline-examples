...
def main():
    ...
    parser.add_argument("--sg_n",                   default="24000", help="ShareGPT rows in the phase-1 training blend (0 disables)")
    parser.add_argument("--uc_n",                   default="19000", help="UltraChat rows in the phase-1 training blend (0 disables)")
    parser.add_argument("--pb_n",                   default="11000", help="PerfectBlend rows in the phase-1 training blend (0 disables)")
    parser.add_argument("--sg_target",              default="25000", help="Target ShareGPT rows regenerated for phase-2 training")
    parser.add_argument("--uc_target",              default="25000", help="Target UltraChat rows regenerated for phase-2 training")
    parser.add_argument("--pb_target",              default="11000", help="Target PerfectBlend rows regenerated for phase-2 training")
    parser.add_argument("--batch_size",             default="4",     help="Per-device batch size, used by phase-1 and phase-2")
    parser.add_argument("--max_length",             default="4096",  help="Max sequence length, used by phase-1 and phase-2")
    ...
    parser.add_argument("--phase1_epochs",          default="10",    help="Number of epochs for phase-1 pretrain")
